...
class Test(unittest.TestCase):
    ...
    def testVarInt(self):
        ...
        check(0, [0])
        check(128, [-128, 1])
        check(60_000, [-32, -44, 3])
        check(60_000_000, [-128, -114, -50, 28])
        check(-1, [-1, -1, -1, -1, 15])
        check(-34, [-34, -1, -1, -1, 15])
        check(0x_1234_5678, [-8, -84, -47, -111, 1])
        check(0x_fedc_ba98 - 0x_1_0000_0000, [-104, -11, -14, -10, 15])
    ...
    def testZigZagInt(self):
        ...
        check(0, [0])
        check(128, [-128, 2])
        check(60_000, [-64, -87, 7])
        check(60_000_000, [-128, -100, -100, 57])
        check(-34, [67])
        check(0x_1234_5678, [-16, -39, -94, -93, 2])
        check(0x_fedc_ba98 - 0x_1_0000_0000, [-49, -107, -102, 18, ])
    ...
    def testSerializer(self):
        ...
        self.assertEqual(
            b,
            fromJava(
                [2, 15, 0, 3, 0, 3, 1, 7, -128, -119, 15, 7, -117, -56, 120, 4, 84, 79, 126, -85, -80, 59, 20, -52,
                 5, 5, 72, 101, 108, 108, 111, 5, 20, 62, 1, 18, 127, -62, -128, -56, -76, -33, -65, -32, -96,
                 -128, -28, -116, -95, -17, -65, -65, 60, 6, 5, 0, 127, -1, 10, -45, 8, -62, 31, 9, 1, 9, 0, 11,
                 1, 1, 2, -10, 1, 3, 4, 89, 65, 83, 83, 0, 14, 1, 3, 7, 2, 7, 4, 7, 6, 0, 15, 1, 63, -16, 0, 0,
                 0, 0, 0, 0, 2, 2, 1, 0, 15, 1, 64, 0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0])
        )
        io.seek(0)
