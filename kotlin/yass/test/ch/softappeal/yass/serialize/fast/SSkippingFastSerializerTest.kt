...
private fun copy(write: SFastSerializer, read: SFastSerializer, input: Any): Any = runBlocking {
...
private fun copyTo2(input: Any) = copy(SSerializer, SSerializer2, input)
private fun copyFrom2(input: Any) = copy(SSerializer2, SSerializer, input)

class SSkippingFastSerializerTest {
    @Test
