...
public final class SslConfig {
    ...
    private static KeyStore readKeyStore(final @Nullable String name) {
        if (name == null) {
            return null;
        }
    ...
    private static SslSetup sslSetup(final @Nullable String keyStore, final @Nullable String trustStore) {
