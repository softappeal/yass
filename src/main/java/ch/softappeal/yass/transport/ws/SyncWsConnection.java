...
public final class SyncWsConnection extends WsConnection {
    ...
    public static final Factory FACTORY = new Factory() {
        @Override public WsConnection create(final WsConfigurator configurator, final Session session1) throws Exception {
            return new SyncWsConnection(configurator, session1);
        }
    };
